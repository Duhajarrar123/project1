...
for ind in range(len(imgsList)):
    ...
    cv2.putText(pic, text=str("This image have a " + str(s-1) + " Lines"), org=(700, row - 120),fontFace=cv2.FONT_HERSHEY_SIMPLEX, fontScale=4, color=(255, 0, 0), thickness=3, lineType=cv2.LINE_AA)
